...
async function onSearchMyLocation() {
  ...
  navigator.geolocation.getCurrentPosition(
    ...
    () => {
      renderError(new Error('Tókst ekki að finna staðsetningu. Vinsamlegast gefið leyfi til að halda áfram'))
    }
  )
}
...
function render(container, locations, onSearch, onSearchMyLocation) {
  ...
  const introductionText = el('p', {}, 'Veldu stað til að sjá hita- og úrkomuspá.');
  parentElement.appendChild(introductionText);
  ...
  const minStadsetningButton = renderLocationButton('Mín staðsetning (þarf leyfi)', onSearchMyLocation);
  locationsListElement.appendChild(minStadsetningButton);
